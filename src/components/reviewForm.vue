<template>
    <div class="modal-overlay" @click.self="closeModal">
        <div class="modal">
            ...
            <h2 class="text-center text-gray-800 text-3xl font-semibold mb-4">Escribe tu reseña</h2>
            <form @submit.prevent="submitReview">
                ...
                <div class="form-group flex flex-col items-center mb-4">
                    ...
                    <textarea rows="3" v-model="comment" placeholder="Que te parecio el producto"
                        class="w-full p-2 border rounded resize-none"></textarea>
                </div>

                <button
                    class="form-group py-3 my-8 text-lg bg-green-500 rounded-xl text-white"
